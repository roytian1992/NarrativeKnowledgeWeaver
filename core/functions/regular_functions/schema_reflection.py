...
class SchemaReflector:
    ...
    def __init__(self, prompt_loader=None, llm=None):
        ...
        # 定义验证规则
        self.required_fields = ["score", "reason"]
    ...
    def call(self, params: str, **kwargs) -> str:
        ...
        try:
            ...
            prompt_id = "reflect_schema_prompt"
            ...
            if status == "success":
                logger.info("反思schema完成，返回格式化后的JSON")
            ...
            logger.error(f"反思schema过程中出现异常: {e}")
            error_result = {
                "error": f"反思schema失败: {str(e)}",
                "reason": "",
                "score": 0
            }
            return correct_json_format(json.dumps(error_result, ensure_ascii=False))
