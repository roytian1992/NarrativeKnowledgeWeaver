...
class AgenticSearch:
    ...
    def __init__(self, prompt_loader=None, llm=None):
        ...
        self.field_validators = {
            "related_content": lambda x: isinstance(x, str)
        }
    ...
    def call(self, params: str, **kwargs) -> str:
        ...
        try:
            ...
            # 渲染提示词
            prompt_text = self.prompt_loader.render_prompt('agentic_search_prompt', variables)
            ...
            if status == "success":
                ...
                error_result = {
                    "error": f"提取信息失败，返回整段文本",
                    "related_content": text
                }
                return correct_json_format(json.dumps(error_result, ensure_ascii=False))
            
        except Exception as e:
            logger.error(f"提取信息过程中出现异常: {e}")
            error_result = {
