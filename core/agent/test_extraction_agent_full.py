...
class InformationExtractionAgent:
    def __init__(self, config, llm, system_prompt, reflector, mode="regular", prompt_loader=None, entity_type_description_text: str = "", relation_type_description_text: str = ""):
        self.config = config
    ...
    def load_schema(self, schema):
        self.entity_type_description_text = schema.get("entity_type_description_tex")
        self.relation_type_description_text = schema.get("relation_type_description_text")
