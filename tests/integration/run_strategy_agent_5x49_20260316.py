...
JSON_PATH = Path(
    os.environ.get("NKW_EVAL_JSON_PATH", str(REPORT_DIR / "we2_strategy_agent_5x49_20260316_source_hint.json"))
)
MD_PATH = Path(
    os.environ.get("NKW_EVAL_MD_PATH", str(REPORT_DIR / "we2_strategy_agent_5x49_20260316_source_hint.md"))
)
REPEATS = 5
AGENT_MAX_WORKERS = max(1, int(os.environ.get("NKW_AGENT_MAX_WORKERS", "4") or "4"))
HYBRID_MAX_WORKERS = max(1, int(os.environ.get("NKW_HYBRID_MAX_WORKERS", "6") or "6"))
